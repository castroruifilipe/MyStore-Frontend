                    ...
                    <Row className="mt-3">
                        <Col className="p-0">
                            <BootstrapTable version='4' pagination data={this.state.clientes}>
                                <TableHeaderColumn isKey dataField='id' dataSort caretRender={this.getCaret} filter={{ type: 'TextFilter' }} className='customHeader' dataAlign='center' width="10%">
                                    Nº cliente
                                </TableHeaderColumn>
                                ...
                                <TableHeaderColumn dataField='contribuinte' dataSort caretRender={this.getCaret} filter={{ type: 'TextFilter' }} className="customHeader" dataAlign='center' width="15%">
                                    Contribuinte
                                </TableHeaderColumn>
